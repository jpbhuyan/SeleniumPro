...
public interface WdMethods {
		...
		/**
		 * This method will elocate an element in webpage
		 * */
		...
		/**
		 * This method will submit the element
		 * @param ele   - The Webelement (button/link/element) to be Submitted
		 * @author Jyoti - TestLeaf
		 */
		public void clickWithNoSnap(WebElement ele);

		/**
		 * This method will click the element without snap
		 * @param ele   - The Webelement (button/link/element) to be Submitted
		 * @author Jyoti - TestLeaf
		 */
		...
		/**
		 * This method will display the number of items in a dropdown and values of the dropdown
		...
		/**
		 * This method will switch to the Default Window
		 * @param index The window index to be switched to. 0 -> first window 
		 * @author Babu - TestLeaf
		 */
		...
		/**
		 * This method will Enter value to the text field present inside Alert and Accept it
		 * @author Babu - TestLeaf
		 */
